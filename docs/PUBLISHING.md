...
Ghosty Tools can be submitted to the Windows Package Manager (WinGet) using the manifest in `manifests/g/Ghostshadowplays/GhostyTools/7.0.0/`.
...
2. Open PowerShell and calculate the SHA256 hash:
   ...
   ```
3. Open `manifests\g\Ghostshadowplays\GhostyTools\7.0.0\Ghostshadowplays.GhostyTools.yaml` in this repository.
...
```powershell
winget validate manifests\g\Ghostshadowplays\GhostyTools\7.0.0\Ghostshadowplays.GhostyTools.yaml
...
2. Run: `wingetcreate submit manifests\g\Ghostshadowplays\GhostyTools\7.0.0\Ghostshadowplays.GhostyTools.yaml`
