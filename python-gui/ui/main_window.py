...
from core.bloat_remover import BloatRemover, BloatwareCategory, SafetyLevel
from core.system_tools_installer import SystemToolsInstaller, ToolCategory
from core.security_scanner import SecurityScanner
from core.update_manager import UpdateManager, UpdateWorker
...
class GhostyTool(QMainWindow):
    ...
    def __init__(self):
        ...
        icon_path = get_resource_path("python-gui/assets/ghosty icon.ico")
...
""")
    ...
    def setup_debloat_page(self):
        ...
        config_path = get_resource_path("python-gui/config/bloatware_config.json")
    ...
    def setup_tools_page(self):
        ...
        config_path = get_resource_path("python-gui/config/system_tools.json")
    ...
    def setup_about_page(self):
        ...
        info_label = QLabel("Ghosty Tool v5.1.1")
        ...
        features_group = QGroupBox("What's New in v5.1.1")
        ...
        github_btn.setIcon(QIcon(get_resource_path("python-gui/assets/GithubLogo.png")))
        ...
        twitch_btn.setIcon(QIcon(get_resource_path("python-gui/assets/twitchlogo.png")))
